...
def caesarCipher( offset, string ):
    ...
    for char in string:
        ...
        newASCIIchar = ord( char ) + offset - 97
        ...
        elif newASCIIchar > 25:
            newString += chr( newASCIIchar - 25 + 97 )

        else:
            newString += chr( newASCIIchar + 97 )

    return newString

# These are tests to check that your code is working. After writing
# your solution, they should all print true.
print( caesarCipher( 3, 'abc' ) )
print( caesarCipher( 3, 'abc xyz' ) )
